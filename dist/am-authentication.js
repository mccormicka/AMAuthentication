...
define("angular-sanitize", ["angular"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.angular-sanitize;
    };
}(this)));
...
define('scripts/login/LoginController',['require','lodash'],function (require) {
...
define('scripts/login/LoginModule',['require','angular-sanitize','angular','scripts/login/LoginDirective','scripts/util/ResponseFormatter','scripts/util/RedirectUtil'],function (require) {
...
define('scripts/register/RegisterModule',['require','angular-sanitize','angular','scripts/register/RegisterDirective','scripts/util/ResponseFormatter','scripts/util/RedirectUtil'],function (require) {
